...
//LLAMAMOS A LOS DATOS DE PRODUCTO SELECCIONADO
...
//TRAEMOS Y SELECCIONAMOS LOS CAMPOS DE LA TABLA PRODUTO SEGUN EL ID QUE HEMOS TRAIDO
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="mt-3">
            <form name="formulario " method="post" action="editar_producto.php">
                <table class="table table-striped table-hover">
                    <tbody>
                        <!--ESCONDEMOS ESTE INPUT PARA GUARDAR EL ID DEL PRODUCTO A EDITAR -->
                        ...
                        <tr>
                            ...
                            <td>                        
                                ...
                                <input type="text" class="form-control" name="nombre" value="<?php echo $producto['nombre'] ?>" maxlength="80" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Descripcion</td>
                            <td>
                                <input type="text" class="form-control" name="descripcion" value="<?php echo $producto['descripcion'] ?>" maxlength="250" required>
                            </td>
                        </tr>
                        <tr>
                            <td>Stock</td>
                        ...
                        <tr>
                            <td>Precio Venta</td>
                            <td>
                                <input type="number" class="form-control" name="precio_venta" value="<?php echo $producto['precio_venta'] ?>" required >
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
